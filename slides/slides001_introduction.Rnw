...
\column{0.5\textwidth}
\includegraphics[width = 1\textwidth]{../resources/images/bandThree2.png}
...
\begin{frame}[c]{Day-to-day reproducible research is about you.}
...
% \vspace{-1\baselineskip}
\includegraphics[width = 1\textwidth]{../resources/images/final-final.png}
\end{columns}
\end{frame}
}%%
...
\begin{itemize}
  ...
  \item {Use version control}
	...
	\item {\color{palegray}Postpone optimization}
